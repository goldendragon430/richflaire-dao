...
approval_program_bytecode = read_teal_bytecode("locker_contract.teal.tok")
clear_program_bytecode = read_teal_bytecode("locker_contract.teal_clear.tok")
...
# CW2LLWVBQAK64HXW5AKKJFZ6H25F25HOFTJY2OC7AVSRXQ3ZC3RQ